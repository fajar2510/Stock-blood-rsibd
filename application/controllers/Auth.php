...
class Auth extends CI_Controller
{
    ...
    public function registration()
    {
        ...
        if ($this->form_validation->run() == false) {
            $data['title'] = 'Aiku User Registration';
            $this->load->view('templates/auth_header', $data);
    ...
    private function _sendEmail($token, $type)
    {
        $config = [
            ...
            'smtp_user' => 'sepertiseharusnyafajar@gmail.com',
            'smtp_pass' => 'eba432id29',
            'smtp_port' => 465,
            'mailtype'  => 'html',
            'charset'   => 'utf-8',
            'newline'   => "\r\n"
        ...
        $this->email->initialize($config);  //load library

        $this->email->from('sepertiseharusnyafajar@gmail', 'Aiku Sofware - InfiniTech');
