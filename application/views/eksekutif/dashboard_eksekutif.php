    ...
    <div class="row">
        ...
        <div class="card shadow mb-4">
            ...
            <div class="collapse show" id="collapseCardExample">
                <div class="card-body">
                    Selamat Datang di Menu Eksekutif ,pelaporan bulanan dan tahunan grafik yang memudahkan analisa anda <strong> membantu ddalam menemukan keputusan bisnis </strong> dan memberikan yang terbaik
                </div>
            </div>
        </div>
    </div>
